$(function() {
	// 申诉异议编号
	$("input[name=appeal]").bigAutocomplete({
		width:274,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
	...
	// 经营许可证/营业执照
	$("input[name=license]").bigAutocomplete({
		width:274,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
	...
	// 身份证号码
	$("input[name=cardId]").bigAutocomplete({
		width:274,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
	...
	// 指标类目名称
	$("input[name=class]").bigAutocomplete({
		width:225,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
	...
	// 指标项目名称
	$("input[name=item]").bigAutocomplete({
		width:225,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
	...
	// 填报企业/个人
	$("input[name=role]").bigAutocomplete({
		width:274,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
	...
	// 描述备注
	$("input[name=remarks]").bigAutocomplete({
		width:274,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
	...
	// 版本号
	$("input[name=edition]").bigAutocomplete({
		width:274,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
	...
	// 数据库字段名
	$("input[name=field]").bigAutocomplete({
		width:274,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
	...
	// 数据库表名
	$("input[name=dataTable]").bigAutocomplete({
		width:225,
		data:[{title:"中国好声音"},
		{title:"中国移动网上营业厅"},
		{title:"中国银行"},
		...
		this.autocomplete = function(param){
			...
			$this.keyup(function(event) {
				...
				if(!isFunctionalKey && (!ctrl || (ctrl && k == 67) || (ctrl && k == 88)) ){
					...
					var h = $this.outerHeight() - 1 + 9; // 2015/10/25增加自定义input外边距为9px
					$bigAutocompleteContent.css({"top":offset.top + h,"left":offset.left - 10}); // 2015/10/25减去自定义input外边距为10px
